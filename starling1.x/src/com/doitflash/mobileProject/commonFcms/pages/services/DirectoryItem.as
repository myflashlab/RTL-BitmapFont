...
//--------------------------------------------------------------------------------------------------------------------- Private
		...
		private function stageAdded(e:Event=null):void 
		{
			...
			if (_status == PageServices.SERVICE_NOT_PURCHASED)
			{
			...
			if (_status == PageServices.SERVICE_NOT_INSTALLED)
			{
		...
		{
			this.dispatchEvent(new ServiceEvent(ServiceEvent.PURCHASE, _xml));
		}
		
		private function onInstall(e:MouseEvent):void
		{
			this.dispatchEvent(new ServiceEvent(ServiceEvent.INSTALL, _xml));
		}
		
		private function onUpdate(e:MouseEvent):void
		{
			this.dispatchEvent(new ServiceEvent(ServiceEvent.UPDATE, _xml));
		}
		
		private function onUninstall(e:MouseEvent):void
		{
			this.dispatchEvent(new ServiceEvent(ServiceEvent.UNINSTALL, _xml));
		}
//--------------------------------------------------------------------------------------------------------------------- Helpful
