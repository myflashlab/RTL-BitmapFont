...
:: Android packaging
set AND_CERT_NAME="RTLBitmap"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\RTLBitmap.p12
...
set IOS_PROVISION=cert\RTLBitmap.mobileprovision
...
:: Output packages
set DIST_PATH=dist
set DIST_NAME=RTLBitmap

:: Debugging using a custom IP
set DEBUG_IP=192.168.1.24
